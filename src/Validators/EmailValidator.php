...
class EmailValidator extends BaseValidator
{
    ...
    public function init()
    {
        ...
        if ($this->enableIDN && !function_exists('idn_to_ascii')) {
            throw new \InvalidArgumentException('In order to use IDN validation intl extension must be installed and enabled.');
        }
        if ($this->message === null) {
            $this->message =  '{attribute} некорректный адрес.';
        }
    }
