...
class StringValidator extends BaseValidator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message =  '{attribute} должен быть строкой.';
        }
        if ($this->min !== null && $this->tooShort === null) {
            $this->tooShort = '{attribute} короче чем {min} символов.';
        }
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = '{attribute} длиннее чем {max} символов.';
        }
        if ($this->length !== null && $this->notEqual === null) {
            $this->notEqual =  '{attribute} должно состоять из {length} символов.';
        }
    }
